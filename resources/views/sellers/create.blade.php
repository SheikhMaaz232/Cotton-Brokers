                            ...
                            <div class="page-title-box">
                                <div class="btn-group float-right">
                                    <ol class="breadcrumb hide-phone p-0 m-0">
                                        <li class="breadcrumb-item"><a href="#">Cotton Broker</a></li>
                                ...
                                <div class="card-body bpv-form">
                                    <form action="{{  !empty($seller) ? route('seller.update') : route('seller.save')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <div class="form-group">
                                                <h6 class="light-dark w-100">Email<span style="color: red">*</span></h6>
                                        ...
                                        <div class="form-inline">
                                            <div class="form-group">
                                                <h6 class="light-dark w-100">Phone Number<span style="color: red">*</span>
                                                </h6>
                                            ...
                                            <div class="form-group">
                                                <h6 class="light-dark w-100">Fax<span style="color: red">*</span></h6>
                                        ...
                                        <div class="form-inline">
                                            <div class="form-group">
                                                <h6 class="light-dark w-100">Bank Check<span style="color: red">*</span>
                                                </h6>
                                                <input type="text" class="form-control" name="bank_branch" id="bank_branch"
                                                    value="{{ old('bank_branch', !empty($seller->bank_branch) ? $seller->bank_branch : '') }}"
                                                    placeholder="Enter Bank Check Number" maxlength="15">
                                                @error('bank_branch')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>

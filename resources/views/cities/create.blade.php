                        ...
                        <div class="col-lg-6">
                            <div class="card m-b-30">
                                <div class="card-body bpv-form">
                                    <form action="{{ !empty($city) ? route('city.update') : route('city.save') }}"
                                        ...
                                        <div class="form-group">
                                            <h6 class="light-dark w-100">City Name<span style="color: red">*</span></h6>
                                            <input type="text" class="form-control" name="name" id="name"
                                                value="{{ old('name', !empty($city->name) ? $city->name : '') }}"
                                                placeholder="Enter City Name" maxlength="30" required>
                                            @error('name')

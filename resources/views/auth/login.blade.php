                ...
                <div class="col-lg-12 pr-0">
                    <div class="form-wrap">
                        <div class="form-inner">
                            ...
                            <h1 style="text-align: center">SHEIKH MUNIR ENTERPRISES</h1>
                            <h6 style="text-align: center">Cotton Broker System</h6>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <input type="text" id="email"
                                        ...
                                        placeholder="Username" style="height: 35px; margin-bottom: -35px">
                                    @error('email')
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <select class="select2 form-control mb-3 custom-select" name="financial_year_id"
                                        id="financial_year_id" style="width: 100%; height:36px;">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="remember" id="remember"
                                                {{ old('remember') ? 'checked' : '' }} style="margin-top: -17px">

                                            <label class="form-check-label" for="remember"
                                                style="background-color: #5dbcd2; margin-left: 3px; margin-top: 5px">
                                                {{ __('Remember Me') }}
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mb-0" style="margin-top: -10px !important;">
                                    <button
                                        style="background-color: #429aa8 !important; border-color: #429aa8">Login</button>
                                </div>

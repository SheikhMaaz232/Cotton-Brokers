                            ...
                            <div class="card m-b-30">
                                <div class="card-body bpv-form">
                                    <form action="{{ !empty($buyer) ? route('buyer.update') : route('buyer.save') }}"
                                        ...
                                        <div class="form-inline">
                                            <div class="form-group">
                                                <h6 class="light-dark w-100">Office Contact Number</h6>
                                        ...
                                        <div class="form-group">
                                            <h6 class="light-dark w-100">Office Address</h6>
                                        ...
                                        <div class="form-group">
                                            <h6 class="light-dark w-100">Mill Address</h6>
                                        ...
                                        <div class="form-inline">
                                            <div class="form-group">
                                                <h6 class="light-dark w-100">Website<span style="color: red">*</span>
                                                </h6>
